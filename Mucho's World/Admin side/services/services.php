        ...
        && isset($_POST['ServicePrice']) && ($_POST['ServicePrice']!=""))
{
    ...
    $query="Insert into Services values('', '$ServiceName', '$ServiceDesc','$ServicePrice')";
    //echo $query;
    ...
    <div class="editor">
        ...
        <form method="post" action="<?php $PHP_SELF?>">
            <table id="tooble"> 
                <tr>
                    <td>Services Name</td>
                    <td><input type="text" name="ServiceName" size="30" required/></td>
                </tr>
                <tr>
                    <td>Services Desc</td>
                    <td><input type="text" name="ServiceDesc" size="30" required/></td>
                </tr>
                <tr>
                    <td>Services Price</td>
                    <td><input type="text" name="ServicePrice" size="30" required/></td>
                </tr>
