...
if (
    ...
    $query = "Insert into Products values('', '$ProductType', '$ProductName','$ProductDesc','$ProductPrice','$ProductImage' ,'$petType')";
    //echo $query;
    ...
    <div class="editor">
        ...
        <form method="post" action="<?php $PHP_SELF ?>" enctype='multipart/form-data'>
            <table id="tooble">
                ...
                <tr>
                    <td>Product Desc</td>
                    <td><input type="text" name="ProductDesc" size="30" required /></td>
                </tr>
                <tr>
                    <td>Product Image</td>
                    <td><input type="file" Productept="image/*" name="ProductImage" size="30" required /></td>
                </tr>
                <tr>
                    <td>Product Price</td>
                    <td><input type="text" name="ProductPrice" size="30" required /></td>
                </tr>
