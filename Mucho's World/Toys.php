...
<body>
        ...
        <ul class="navbar-nav ml-auto  ">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item active" href="Toys.php">Toys</a></li>
  ...
  <div class="container-fluid d-flex justify-content-evenly align-content-between myflex">
    ...
    $query = "Select * from Products where ProductType='Toys' ";
    $result = mysqli_query($con, $query);
    $nbr = mysqli_num_rows($result);

    if ($nbr == 0) {
      echo "There are no Toy for this pet at the moment";
    } else {
      for ($i = 0; $i < $nbr; $i++) {
        ...
        if (isset($_SESSION['isLoggedIn'])) {
          ...
          echo "<a href='loginpage.php?from=Toys' class='btn btn-primary'>add to cart</a>";
        }
        echo  "</div>";
        echo  "</div>";
      }
