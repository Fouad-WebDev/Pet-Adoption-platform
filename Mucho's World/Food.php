...
<body>
        ...
        <ul class="navbar-nav ml-auto  ">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item active" href="Food.php">Food</a></li>
            </ul>
  ...
  <div class="container-fluid d-flex justify-content-evenly align-content-between myflex">
    ...
    $query = "Select * from Products where ProductType='Food' ";
    $result = mysqli_query($con, $query);
    $nbr = mysqli_num_rows($result);

    if ($nbr == 0) {
      echo "There are no food for this pet at the moments";
    } else {
      for ($i = 0; $i < $nbr; $i++) {
        ...
        if (isset($_SESSION['isLoggedIn'])) {
          ...
          echo "<a href='loginpage.php?from=Food' class='btn btn-primary'>add to cart</a>";
        }
        echo  "</div>";
        echo  "</div>";
      }
