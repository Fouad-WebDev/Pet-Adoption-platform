...
<style>
  .service-item {
    margin-bottom: 100px;
    /* Adjust this value to control the vertical separation */
  }
</style>
...
<body>
  ...
  <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate service-item">
    <div class="d-block services text-center">
      <div class="icon d-flex align-items-center justify-content-center">
        <span class="flaticon-pawprint-1"></span>
      </div>
      <div class="media-body p-4">
        <h3 class="heading">' . $fetch['ServiceName'] . '</h3>
        <p>' . $fetch['ServiceDesc'] . '</p>
        <h2>$' . $fetch['ServicePrice'] . '</h2>
      </div>
    </div>
  </div>
';
